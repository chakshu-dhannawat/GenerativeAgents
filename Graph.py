...
def makeTown():
    ...
    town.addEdge("Intermediate05","Hut 2"),
    ...
    town.addEdge("Hut 1","Intermediate04"),
    ...
    town.addEdge("Hut 1 task02","Hut 1 Intermediate04"),
    town.addEdge("Hut 1 task03","Hut 1 Intermediate05"),
    ...
    town.addEdge("Hut 2 task02","Hut 2 Intermediate04"),
    town.addEdge("Hut 2 task03","Hut 2 Intermediate05"),
