...
def makeTown():
    ...
    town.addEdge("Cattle Farm task03","Cattle Farm task04"),
    town.addEdge("Cattle Farm","Intermediate01"),
    town.addEdge("Intermediate01","Fishing Pond"),
    town.addEdge("Intermediate09","Fishing Pond"),
    town.addEdge("Intermediate09","Fishing Pond task02"),
    town.addEdge("Intermediate08","Fishing Pond task02"),
    town.addEdge("Intermediate08","Fishing Pond task01"),
    ...
    town.addEdge("Intermediate02","Hut 2"),
    town.addEdge("Hut 2","Hut 2 task01"),
    town.addEdge("Hut 2","Hut 1"),
    town.addEdge("Hut 1","Hut 1 task01"),
    town.addEdge("Hut 1","Intermediate07"),
    town.addEdge("Intermediate07","Electricity House"),
    ...
    town.addEdge("Electricity House","Intermediate06"),
    town.addEdge("Intermediate06","Shrine"),
    town.addEdge("Shrine","Shrine task01"),
    town.addEdge("Shrine task01","Shrine task02"),
    town.addEdge("Shrine task02","Shrine task03"),
    town.addEdge("Shrine task03","Shrine task04"),
    town.addEdge("Shrine","Intermediate05"),
    town.addEdge("Intermediate05","Intermediate07"),
    ...
    town.addEdge("Intermediate05","Intermediate04"),
    town.addEdge("Well","Intermediate04"),
    town.addEdge("Well","Well task01"),
    town.addEdge("Well task01","Well task02"),
    town.addEdge("Well task02","Well task03"),
    town.addEdge("Well task03","Well task04"),
    town.addEdge("Intermediate02","Well"),
    town.addEdge("Intermediate03","Well"),
    town.addEdge("Intermediate02","Intermediate03"),
    town.addEdge("Intermediate04","Tavern"),
    town.addEdge("Intermediate03","Tavern"),
